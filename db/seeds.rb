...
Game.create(name: "Snake", genre: "Action", game_image_url: "https://i.imgur.com/fnryGbX.png")
...
puts "Seeding Users"
User.create(name: "Zach", email: "fakejldashfjkalshdfjkal@gmail.com", username: "zgoodz", profile_img: "https://previews.123rf.com/images/drizzd/drizzd1204/drizzd120400002/12973730-funny-potato-with-cartoon-face-3d-illustration.jpg", password: "1234")
User.create(name: "Nate", email: "fakeemaildhfjkalhdfjklasdyufile@gmail.com", username: "n-dawg", profile_img: "https://i.guim.co.uk/img/static/sys-images/Guardian/Pix/pictures/2015/7/20/1437402009746/Mr-Potato-Head-009.jpg?width=445&quality=45&auto=format&fit=max&dpr=2&s=f9c6a01d746dcf09e58162aeaaec129c", password: "1234")
User.create(name: "Elisa", email: "f123456789@gmail.com", username: "e-dawg", profile_img: "https://www.publicdomainpictures.net/pictures/100000/velka/toothed-potato-face.jpg", password: "1234")
User.create(name: "Adam", email: "fakeueyfhuiwehfsjdkfhjkdlahfjakdhnfjkal@yahoo.com", username: "LaMAO", profile_img: "https://i.redd.it/vqz55oda7v341.jpg", password: "1234")
